  ...
  return (
    ...
    >
      {/* --- Top Section --- */}
        ...
        >
          {/* Only show logo + text when expanded */}
          {isExpanded && (
            <div className="flex items-center gap-3 overflow-hidden">
              ...
              <div>
                <h1 className="font-marcellus text-2xl font-bold text-white leading-tight">BIDA</h1>
                <p className="text-xs text-gray-400">Available services</p>
              </div>
            </div>
          )}

          {/* Toggle Button (always visible and centered when collapsed) */}
          <button
